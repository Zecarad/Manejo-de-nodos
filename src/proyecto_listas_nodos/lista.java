...
public class lista {
    ...
    private int tamanio;
     ...
     public boolean esVacia(){  ////verefica si no hay elementos en la lista
        return inicio == null;

    }

     public int getTamanio(){  ////conuslta posiciones en los nodos
        return tamanio;
    }
        ...
        if(posicion>=0 && posicion<=tamanio){
            ...
            if(posicion == 0){
                ...
                if(posicion == tamanio){
                    ...
                    // Inserta el nuevo nodo despues de del ultimo. // 2 5 2 6 8
                    aux.setSiguiente(nuevo);              
                }
                else{
